...
type CloudDiscovery struct {
	...
	Name           string         `gorm:"column:name; type:varchar(128);" json:"name" binding:"required"`              // 任务名称
	ResourceType   int            `gorm:"column:resource_type; type:int(11);" json:"resource_type" binding:"required"` // 资源类型
	CloudAccount   int            `gorm:"column:cloud_account; type:int(11);" json:"cloud_account" binding:"required"` // 云账户
