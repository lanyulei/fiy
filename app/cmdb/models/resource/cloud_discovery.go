...
type CloudDiscovery struct {
	...
	Name           string         `gorm:"column:name; type:varchar(128);uniqueIndex:idx_unique;" json:"name" binding:"required"`              // 任务名称
	ResourceType   int            `gorm:"column:resource_type; type:int(11);uniqueIndex:idx_unique;" json:"resource_type" binding:"required"` // 资源类型
	...
	LastSyncTime   time.Time      `gorm:"column:last_sync_time; type:datetime;" json:"last_sync_time"`                                        // 最近同步状态
