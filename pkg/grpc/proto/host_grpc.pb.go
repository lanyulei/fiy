...
type HostInfoClient interface {
	GetHostInfo(ctx context.Context, in *HostInfoRequest, opts ...grpc.CallOption) (*CommonReply, error)
}
...
func (c *hostInfoClient) GetHostInfo(ctx context.Context, in *HostInfoRequest, opts ...grpc.CallOption) (*CommonReply, error) {
	out := new(CommonReply)
...
type HostInfoServer interface {
	GetHostInfo(context.Context, *HostInfoRequest) (*CommonReply, error)
...
func (UnimplementedHostInfoServer) GetHostInfo(context.Context, *HostInfoRequest) (*CommonReply, error) {
