...
import (
	...
	_ "fiy/cmd/migrate/migration/version"
	_ "fiy/cmd/migrate/migration/version-local"
	"fiy/common/database"
	"fiy/common/global"
	"fiy/common/models"
	"fiy/pkg/logger"
...
var (
	...
	StartCmd  = &cobra.Command{
		...
		Example: "fiy migrate -c config/settings.yml",
...
func init() {
	...
	StartCmd.PersistentFlags().BoolVarP(&goAdmin, "goAdmin", "a", false, "generate fiy migration file")
}
